...
2. Revert commit X (the middle one) — what happens?
3. Check `git log` — is commit X still in the history?

    - Commit X is still in the history.A new commit was added.
...
https://github.com/2184mk-cell/devops-git-practice/blob/main/git-command.md

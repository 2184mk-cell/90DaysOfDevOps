...
- `Example:`
    ...
    terraform import aws_s3_bucket.imported terraweek-import-test-maheshkumar
    ```
...
1. `Write the Terraform resource block:`
  - Make sure the name matches the existing bucket exactly:
    ...
    bucket = "terraweek-import-test-maheshkumar"
    }
    ```
...
2. `Import the existing bucket`
  ...
  - Here:
    ...
    `terraweek-import-test-maheshkumar` : existing AWS bucket name

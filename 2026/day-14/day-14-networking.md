...
- Observation: EC2 instance private IP is 172.0.2.15 (internal AWS VPC network).
  ![hostname](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/hostname.png)
...
- Observation: Excellent network connectivity with ~1ms latency**
  ![ping](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/ping.png)
...
- Obervation: Successfully reached the destonation at hop 20,depspite a block of timeouts (* * *) on hops 11-29 caused by network security filtering.
  ![traceroute](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/traceroute.png)
...
- Observation: SSH is listening on port 22 (on 0.0.0.0, meaning it accepts outside connections),and the local DNS resolver is listening on port 53 (on 127.0.0.53, for internal system use only)
  ![tuln](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/tuln.png)


- **Name resolution:** `dig google.com`
- Observation: The DNS query returned status: NOERROR and successfully resolved google.com to  IP address: 142.250.193.110
  ![dig](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/dig.png)
...
- Observation: Received HTTP status 301 (Moved Permanently), indicating the server is redirecting the request to https://www.google.com/
  ![tuln](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/curl.png)
...
- Observation: Captured 1 ESTABLISHED connection on port 22 (the active SSH session) and multiple ports in LISTEN state.
  ![netstat](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/netstat.png)
...
- From the same machine, test it: `nc -zv localhost 22`
  ![port_probe](https://github.com/2184mk-cell/90DaysOfDevOps/blob/master/2026/day-14/port_probe.png)

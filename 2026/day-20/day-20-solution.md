...
3. Display them with their occurrence count, sorted in descending order
   ...
   ![images](images/top_err_1.png)

---

### Task 5: Summary Report
Generate a summary report to a text file named `log_report_<date>.txt` (e.g., `log_report_2026-06-05.txt`). The report should include:
1. Date of analysis
2. Log file name

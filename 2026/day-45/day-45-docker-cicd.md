...
[Docker-Hub](https://hub.docker.com/repository/docker/ermaheshkumar/webapp/general)
...
6. Run the container: `docker run -d --name web -p 80:80 ermaheshkumar/webapp:latest`
...
This creates `bankapp-0.2.0.tgz`.

**Bump the version after changes:**
Edit `bankapp/Chart.yaml`:
```yaml
version: 0.3.0        # Chart structure changed (added hooks)
...
Now you have `bankapp-0.2.0.tgz` and `bankapp-0.3.0.tgz`.
...
helm repo index chart-repo/ --url https://ermaheshkumar.github.io/helm-charts

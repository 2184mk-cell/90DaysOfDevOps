...
```
![image](images/task5-apply-dev-1.png)

![image](images/task5-apply-dev-2.png)
...
```
![image](images/task5-apply-stagging-1.png)

![image](images/task5-apply-stagging-2.png)
...
```
![image](images/task5-apply-prod-1.png)

![image](images/task5-apply-prod-2.png)
...
```
![image](images/dev-output.png)
![image](images/stagging-output.png)
![image](images/prod-output.png)
...
![image](images/ec2-all-env.png)
![image](images/vpc-all-env.png)
![image](images/s3-all-env.png)
...
```
![image](images/dev-destroy.png)
![image](images/stagging-destroy.png)
![image](images/prod-destroy.png)

Verify in the AWS console -- all VPCs, instances, security groups, and gateways should be gone.

![image](images/aws-ec2-console-after-destroy.png)
![image](images/aws-vpc-console-after-destroy.png)
